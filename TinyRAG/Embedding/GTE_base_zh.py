...
if __name__ == '__main__':
    ...
    q_embeddings = GTE.get_embedding([instruction + q for q in queries])
    p_embeddings = GTE.get_embedding(passages)
    scores = GTE.compute_similarity(q_embeddings, p_embeddings)
    print(scores)
